module.exports = class Data1672296365078 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "plot_operation_record" ("id" character varying NOT NULL, "tx_hash" text NOT NULL, "block" integer NOT NULL, "timestamp" numeric NOT NULL, "type" text NOT NULL, "price" numeric, "plot_id" character varying, "operator_id" character varying, "receiver_id" character varying, CONSTRAINT "PK_1107596a525508794ed841da53f" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "plot" ("id" character varying NOT NULL, "plot_id" numeric NOT NULL, "data" jsonb NOT NULL, "last_modified_block" integer NOT NULL, "last_modified_time" numeric NOT NULL, "buyer_id" character varying, "owner_id" character varying, "referrer_id" character varying, "sale_id" character varying, CONSTRAINT "PK_7c22bdc3280a3a5610c63159883" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "plot" ADD CONSTRAINT "FK_ec89184fd249370e4c5c41d3abe" FOREIGN KEY ("owner_id") REFERENCES "buyer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
